    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attributes_string', models.TextField(blank=True, default='', null=True, verbose_name='Attributes Data')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_type', models.CharField(blank=True, default='text', max_length=32, null=True, verbose_name='Type')),
                ('order_by', models.CharField(blank=True, default='', max_length=64, null=True, verbose_name='Order By')),
                ('app_added', models.DateTimeField(auto_now_add=True, help_text='')),
                ('app_last_sync', models.DateTimeField(auto_now=True, help_text='')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('count', models.IntegerField(default=0, verbose_name='Count (RO)')),
                ('productattribute', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='outlet_woo.ProductAttribute')),
            ],
            options={
                'ordering': ['name', 'code'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('backordered', models.BooleanField(default=False, help_text='READONLY. Shows if a product is on backorder (if the product have the stock_quantity negative).', verbose_name='Backordered?')),
                ('weight', models.DecimalField(decimal_places=2, default=0, help_text='Product weight in decimal format.', max_digits=10, verbose_name='Weight')),
                ('att_color', models.CharField(blank=True, default='', max_length=64, null=True, verbose_name='Color')),
                ('att_size', models.CharField(blank=True, default='', max_length=64, null=True, verbose_name='Size')),
                ('att_color_obj', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.Color')),
                ('att_size_obj', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.Size')),
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='outlet_woo.Product')),
            ],
            options={
                'ordering': ['name', 'code'],
        ...
        migrations.AddField(
            model_name='product',
            name='categories',
            field=models.ManyToManyField(to='outlet_woo.ProductCategory'),
        ),
        migrations.AddField(
            model_name='product',
            name='design',
        ...
        migrations.AddField(
            model_name='product',
            name='tags',
            field=models.ManyToManyField(to='outlet_woo.ProductTag'),
        ),
    ]
