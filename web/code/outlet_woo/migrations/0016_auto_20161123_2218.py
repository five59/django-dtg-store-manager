...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('outlet_woo', '0015_auto_20161123_2209'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'verbose_name_plural': 'Product Attribute Term',
                'ordering': ['name', 'code'],
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='outlet_woo.ProductAttribute'),
        ),
    ]
