...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('outlet_woo', '0002_auto_20161210_2006'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ImageField(blank=True, help_text='Should be 900x900 pixels (3"x3" @ 300dpi)', null=True, upload_to='', verbose_name='Product Label Base'),
        ),
    ]
